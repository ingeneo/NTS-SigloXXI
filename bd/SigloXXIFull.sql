CREATE DATABASE  IF NOT EXISTS `nts` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `nts`;
-- MySQL dump 10.13  Distrib 8.0.16, for Win64 (x86_64)
--
-- Host: localhost    Database: nts
-- ------------------------------------------------------
...
CREATE TABLE `bodega` (
  ...
  KEY `fk_Bodega_Municipios1_idx` (`Municipios_id_municipio`),
  CONSTRAINT `fk_Bodega_Municipios1` FOREIGN KEY (`Municipios_id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `bodega` VALUES (1,'Norte','Cra 243','5555555',107),(2,'Sur','Call 4 sur 27','2333333',91),(3,'NorOccidente','Calle lejos con cra cerca','2333551',756),(4,'Oeste','Cra 75 # 45-98','9632587',640),(5,'Este','Calle 125 #7-98','2659874',750);
...
CREATE TABLE `cajas` (
  ...
  PRIMARY KEY (`id_caja`),
  KEY `fk_Cajas_Ubicacion_caja1_idx` (`Ubicacion_caja_id_ubicacion_caja`),
  KEY `fk_Cajas_Estado_item1_idx` (`Estado_item_id_estado_item`),
  KEY `fk_Cajas_Tipo_caja1_idx` (`Tipo_caja_id_tipo_caja`),
  CONSTRAINT `fk_Cajas_Estado_item1` FOREIGN KEY (`Estado_item_id_estado_item`) REFERENCES `estado_item` (`id_estado_item`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cajas_Tipo_caja1` FOREIGN KEY (`Tipo_caja_id_tipo_caja`) REFERENCES `tipo_caja` (`id_tipo_caja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cajas_Ubicacion_caja1` FOREIGN KEY (`Ubicacion_caja_id_ubicacion_caja`) REFERENCES `ubicacion_caja` (`id_ubicacion_caja`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cajas` VALUES (1,'Caja1','Primera Caja',1,1,1),(2,'Caja 2','Segunda Caja',240,1,2),(3,'Caja 3','Tercera Caja',120,1,1),(4,'Caja 4','Cuarta Caja',76,2,2),(5,'Caja 5','Quinta Caja',298,1,1);
/*!40000 ALTER TABLE `cajas` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cajas_has_prestamo`
--

DROP TABLE IF EXISTS `cajas_has_prestamo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `cajas_has_prestamo` (
  ...
  KEY `fk_Cajas_has_Prestamo_Prestamo1_idx` (`Prestamo_id_prestamo`),
  KEY `fk_Cajas_has_Prestamo_Cajas1_idx` (`Cajas_id_caja`),
  CONSTRAINT `fk_Cajas_has_Prestamo_Cajas1` FOREIGN KEY (`Cajas_id_caja`) REFERENCES `cajas` (`id_caja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Cajas_has_Prestamo_Prestamo1` FOREIGN KEY (`Prestamo_id_prestamo`) REFERENCES `prestamo` (`id_prestamo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cajas_has_prestamo`
--

LOCK TABLES `cajas_has_prestamo` WRITE;
/*!40000 ALTER TABLE `cajas_has_prestamo` DISABLE KEYS */;
/*!40000 ALTER TABLE `cajas_has_prestamo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cara` (
  ...
  PRIMARY KEY (`id_cara`),
  KEY `fk_Cara_Estante1_idx` (`Estante_id_estante`),
  CONSTRAINT `fk_Cara_Estante1` FOREIGN KEY (`Estante_id_estante`) REFERENCES `estante` (`id_estante`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `cara` WRITE;
/*!40000 ALTER TABLE `cara` DISABLE KEYS */;
INSERT INTO `cara` VALUES (1,'Cara Uno',1),(2,'Cara Dos',1),(3,'Cara Uno',2),(4,'Cara Dos',2),(5,'Cara Uno',3),(6,'Cara Dos',3),(7,'Cara Uno',4),(8,'Cara Dos',4),(9,'Cara Uno',5),(10,'Cara Dos',5),(11,'Cara Uno',6),(12,'Cara Dos',6),(13,'Cara Uno',7),(14,'Cara Dos',7),(15,'Cara Uno',8),(16,'Cara Dos',8),(17,'Cara Uno',9),(18,'Cara Dos',9),(19,'Cara Uno',10),(20,'Cara Dos',10);
/*!40000 ALTER TABLE `cara` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `carpeta` (
  ...
  KEY `fk_Carpeta_Cajas1_idx` (`Cajas_id_caja`),
  KEY `fk_Carpeta_Estado_item1_idx` (`Estado_item_id_estado_item`),
  CONSTRAINT `fk_Carpeta_Cajas1` FOREIGN KEY (`Cajas_id_caja`) REFERENCES `cajas` (`id_caja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Carpeta_Estado_item1` FOREIGN KEY (`Estado_item_id_estado_item`) REFERENCES `estado_item` (`id_estado_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `carpeta` VALUES (1,'Carpeta Uno',1,1),(2,'Carpeta Dos',1,1),(3,'Carpeta Uno',3,1),(4,'Carpeta Uno ',2,1),(5,'Carpeta Dos',2,2),(6,'Carpeta Uno',4,1),(7,'Carpeta Uno',5,1),(8,'Carpeta Dos',4,2);
...
CREATE TABLE `clientes` (
  ...
  KEY `fk_Gestores_Municipios1_idx` (`Municipios_id_municipio`),
  CONSTRAINT `fk_Gestores_Municipios1` FOREIGN KEY (`Municipios_id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `clientes` VALUES (1,'830027960-7','SigloXXI','Cra falsa','7999999','siglo@nts.com',107),(2,'810028050-7','Inversiones Dentales Santander','Bucaramanga','8521414','sede@nts',118),(3,'830028950-5','Damasalud S.A','Bogota','5698742','Sonria@sonria.com.co',275),(4,'820095987-7','Inversiones Dentales del Caribe','Barranquilla','5643127','caribe@barranquilla.com',88);
...
INSERT INTO `departamento` VALUES (5,'ANTIOQUIA'),(8,'ATLÁNTICO'),(11,'BOGOTÁ, D.C.'),(13,'BOLÍVAR'),(15,'BOYACÁ'),(17,'CALDAS'),(18,'CAQUETÁ'),(19,'CAUCA'),(20,'CESAR'),(23,'CÓRDOBA'),(25,'CUNDINAMARCA'),(27,'CHOCÓ'),(41,'HUILA'),(44,'LA GUAJIRA'),(47,'MAGDALENA'),(50,'META'),(52,'NARIÑO'),(54,'NORTE DE SANTANDER'),(63,'QUINDIO'),(66,'RISARALDA'),(68,'SANTANDER'),(70,'SUCRE'),(73,'TOLIMA'),(76,'VALLE DEL CAUCA'),(81,'ARAUCA'),(85,'CASANARE'),(86,'PUTUMAYO'),(88,'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SAN'),(91,'AMAZONAS'),(94,'GUAINÍA'),(95,'GUAVIARE'),(97,'VAUPÉS'),(99,'VICHADA');
/*!40000 ALTER TABLE `departamento` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `entrepano`
--

DROP TABLE IF EXISTS `entrepano`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `entrepano` (
  ...
  KEY `fk_Entrepano_Piso1_idx` (`Piso_id_piso`),
  KEY `fk_Entrepano_Modulo1_idx` (`Modulo_id_modulo`),
  KEY `fk_Entrepano_Cara1_idx` (`Cara_id_cara`),
  KEY `fk_Entrepano_Estante1_idx` (`Estante_id_estante`),
  CONSTRAINT `fk_Entrepano_Cara1` FOREIGN KEY (`Cara_id_cara`) REFERENCES `cara` (`id_cara`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entrepano_Estante1` FOREIGN KEY (`Estante_id_estante`) REFERENCES `estante` (`id_estante`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entrepano_Modulo1` FOREIGN KEY (`Modulo_id_modulo`) REFERENCES `modulo` (`id_modulo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entrepano_Piso1` FOREIGN KEY (`Piso_id_piso`) REFERENCES `piso` (`id_piso`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `entrepano`
--

LOCK TABLES `entrepano` WRITE;
/*!40000 ALTER TABLE `entrepano` DISABLE KEYS */;
INSERT INTO `entrepano` VALUES (1,'Entrepaño Uno',1,1,1,1),(2,'Entrepaño Uno',1,2,2,2),(3,'Entrepaño Uno',2,3,3,3),(4,'Entrepaño Uno',2,4,4,4),(5,'Entrepaño Uno',3,5,5,5),(6,'Entrepaño Uno',3,6,6,6),(7,'Entrepaño Uno',4,7,7,7),(8,'Entrepaño Uno',4,8,8,8),(9,'Entrepaño Uno',5,9,9,9),(10,'Entrepaño Uno',5,10,10,10),(11,'Entrepaño Uno',6,11,11,11),(12,'Entrepaño Uno',6,12,12,12),(13,'Entrepaño Uno',7,13,13,13),(14,'Entrepaño Uno',7,14,14,14),(15,'Entrepaño Uno',8,15,15,15),(16,'Entrepaño Uno',8,16,16,16),(17,'Entrepaño Uno',9,17,17,17),(18,'Entrepaño Uno',9,18,18,18),(19,'Entrepaño Uno',10,19,19,19),(20,'Entrepaño Uno',10,20,20,20),(21,'Entrepaño Uno',1,1,21,21),(22,'Entrepaño Uno',1,2,22,22),(23,'Entrepaño Uno',2,3,23,23),(24,'Entrepaño Uno',2,4,24,24),(25,'Entrepaño Uno',3,5,25,25),(26,'Entrepaño Uno',3,6,26,25),(27,'Entrepaño Uno',4,7,27,27),(28,'Entrepaño Uno',4,8,28,28),(29,'Entrepaño Uno',5,9,29,29),(30,'Entrepaño Uno',5,10,30,30),(31,'Entrepaño Uno',6,11,31,31),(32,'Entrepaño Uno',6,12,32,32),(33,'Entrepaño Uno',7,13,33,33),(34,'Entrepaño Uno',7,14,34,34),(35,'Entrepaño Uno',8,15,35,35),(36,'Entrepaño Uno',8,16,36,36),(37,'Entrepaño Uno',9,17,37,37),(38,'Entrepaño Uno',9,18,38,38),(39,'Entrepaño Uno',10,19,39,39),(40,'Entrepaño Uno',10,20,40,40),(41,'Entrepaño Uno',1,1,1,41),(42,'Entrepaño Uno',1,2,2,42),(43,'Entrepaño Uno',2,3,3,43),(44,'Entrepaño Uno',2,4,4,44),(45,'Entrepaño Uno',3,5,5,45),(46,'Entrepaño Uno',3,6,6,46),(47,'Entrepaño Uno',4,7,7,47),(48,'Entrepaño Uno',4,8,8,48),(49,'Entrepaño Uno',5,9,9,49),(50,'Entrepaño Uno',5,10,10,50),(51,'Entrepaño Uno',6,11,11,51),(52,'Entrepaño Uno',6,12,12,52),(53,'Entrepaño Uno',7,13,13,53),(54,'Entrepaño Uno',7,14,14,54),(55,'Entrepaño Uno',8,15,15,55),(56,'Entrepaño Uno',8,16,16,56),(57,'Entrepaño Uno',9,17,17,57),(58,'Entrepaño Uno',9,18,18,58),(59,'Entrepaño Uno',10,19,19,59),(60,'Entrepaño Uno',10,20,20,60),(61,'Entrepaño Uno',1,1,21,61),(62,'Entrepaño Uno',1,2,22,62),(63,'Entrepaño Uno',2,3,23,63),(64,'Entrepaño Uno',2,4,24,64),(65,'Entrepaño Uno',3,5,25,65),(66,'Entrepaño Uno',3,6,26,66),(67,'Entrepaño Uno',4,7,27,67),(68,'Entrepaño Uno',4,8,28,68),(69,'Entrepaño Uno',5,9,29,69),(70,'Entrepaño Uno',5,10,30,70),(71,'Entrepaño Uno',6,11,31,71),(72,'Entrepaño Uno',6,12,32,72),(73,'Entrepaño Uno',7,13,33,73),(74,'Entrepaño Uno',7,14,34,74),(75,'Entrepaño Uno',8,15,35,75),(76,'Entrepaño Uno',8,16,36,76),(77,'Entrepaño Uno',9,17,37,77),(78,'Entrepaño Uno',9,18,38,78),(79,'Entrepaño Uno',10,19,39,79),(80,'Entrepaño Uno',10,20,40,80),(81,'Entrepaño Dos',1,1,1,1),(82,'Entrepaño Dos',1,2,2,2),(83,'Entrepaño Dos',2,3,3,3),(84,'Entrepaño Dos',2,4,4,4),(85,'Entrepaño Dos',3,5,5,5),(86,'Entrepaño Dos',3,6,6,6),(87,'Entrepaño Dos',4,7,7,7),(88,'Entrepaño Dos',4,8,8,8),(89,'Entrepaño Dos',5,9,9,9),(90,'Entrepaño Dos',5,10,10,10),(91,'Entrepaño Dos',6,11,11,11),(92,'Entrepaño Dos',6,12,12,12),(93,'Entrepaño Dos',7,13,13,13),(94,'Entrepaño Dos',7,14,14,14),(95,'Entrepaño Dos',8,15,15,15),(96,'Entrepaño Dos',8,16,16,16),(97,'Entrepaño Dos',9,17,17,17),(98,'Entrepaño Dos',9,18,18,18),(99,'Entrepaño Dos',10,19,19,19),(100,'Entrepaño Dos',10,20,20,20),(101,'Entrepaño Dos',1,1,21,21),(102,'Entrepaño Dos',1,2,22,22),(103,'Entrepaño Dos',2,3,23,23),(104,'Entrepaño Dos',2,4,24,24),(105,'Entrepaño Dos',3,5,25,25),(106,'Entrepaño Dos',3,6,26,25),(107,'Entrepaño Dos',4,7,27,27),(108,'Entrepaño Dos',4,8,28,28),(109,'Entrepaño Dos',5,9,29,29),(110,'Entrepaño Dos',5,10,30,30),(111,'Entrepaño Dos',6,11,31,31),(112,'Entrepaño Dos',6,12,32,32),(113,'Entrepaño Dos',7,13,33,33),(114,'Entrepaño Dos',7,14,34,34),(115,'Entrepaño Dos',8,15,35,35),(116,'Entrepaño Dos',8,16,36,36),(117,'Entrepaño Dos',9,17,37,37),(118,'Entrepaño Dos',9,18,38,38),(119,'Entrepaño Dos',10,19,39,39),(120,'Entrepaño Dos',10,20,40,40),(121,'Entrepaño Dos',1,1,1,41),(122,'Entrepaño Dos',1,2,2,42),(123,'Entrepaño Dos',2,3,3,43),(124,'Entrepaño Dos',2,4,4,44),(125,'Entrepaño Dos',3,5,5,45),(126,'Entrepaño Dos',3,6,6,46),(127,'Entrepaño Dos',4,7,7,47),(128,'Entrepaño Dos',4,8,8,48),(129,'Entrepaño Dos',5,9,9,49),(130,'Entrepaño Dos',5,10,10,50),(131,'Entrepaño Dos',6,11,11,51),(132,'Entrepaño Dos',6,12,12,52),(133,'Entrepaño Dos',7,13,13,53),(134,'Entrepaño Dos',7,14,14,54),(135,'Entrepaño Dos',8,15,15,55),(136,'Entrepaño Dos',8,16,16,56),(137,'Entrepaño Dos',9,17,17,57),(138,'Entrepaño Dos',9,18,18,58),(139,'Entrepaño Dos',10,19,19,59),(140,'Entrepaño Dos',10,20,20,60),(141,'Entrepaño Dos',1,1,21,61),(142,'Entrepaño Dos',1,2,22,62),(143,'Entrepaño Dos',2,3,23,63),(144,'Entrepaño Dos',2,4,24,64),(145,'Entrepaño Dos',3,5,25,65),(146,'Entrepaño Dos',3,6,26,66),(147,'Entrepaño Dos',4,7,27,67),(148,'Entrepaño Dos',4,8,28,68),(149,'Entrepaño Dos',5,9,29,69),(150,'Entrepaño Dos',5,10,30,70),(151,'Entrepaño Dos',6,11,31,71),(152,'Entrepaño Dos',6,12,32,72),(153,'Entrepaño Dos',7,13,33,73),(154,'Entrepaño Dos',7,14,34,74),(155,'Entrepaño Dos',8,15,35,75),(156,'Entrepaño Dos',8,16,36,76),(157,'Entrepaño Dos',9,17,37,77),(158,'Entrepaño Dos',9,18,38,78),(159,'Entrepaño Dos',10,19,39,79),(160,'Entrepaño Dos',10,20,40,80);
/*!40000 ALTER TABLE `entrepano` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `estado_item` WRITE;
/*!40000 ALTER TABLE `estado_item` DISABLE KEYS */;
INSERT INTO `estado_item` VALUES (1,'Custodia'),(2,'Prestado');
/*!40000 ALTER TABLE `estado_item` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `estante` (
  ...
  KEY `fk_Estante_Bodega1_idx` (`Bodega_id_bodega`),
  CONSTRAINT `fk_Estante_Bodega1` FOREIGN KEY (`Bodega_id_bodega`) REFERENCES `bodega` (`id_bodega`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `estante` VALUES (1,'Estante Uno',1),(2,'Estante Dos',1),(3,'Estante Uno',2),(4,'Estante Dos',2),(5,'Estante Uno',3),(6,'Estante Dos',3),(7,'Estante Uno',4),(8,'Estante Dos',4),(9,'Estante Uno',5),(10,'Estante Dos',5);
...
CREATE TABLE `folio` (
  ...
  KEY `fk_Folio_Carpeta1_idx` (`Carpeta_id_carpeta`),
  KEY `fk_Folio_Estado_item1_idx` (`Estado_item_id_estado_item`),
  CONSTRAINT `fk_Folio_Carpeta1` FOREIGN KEY (`Carpeta_id_carpeta`) REFERENCES `carpeta` (`id_carpeta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Folio_Estado_item1` FOREIGN KEY (`Estado_item_id_estado_item`) REFERENCES `estado_item` (`id_estado_item`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `folio` VALUES (1,'Folio Uno','Folio Uno',1,1),(2,'Folio Uno','Folio Uno',2,1),(3,'Folio Uno','Folio Uno',3,1),(4,'Folio Uno','Folio Uno',4,1),(5,'Folio Uno','Folio Uno',5,2),(6,'Folio Uno','Folio Uno',6,1),(7,'Folio Uno','Folio Uno',7,2),(8,'Folio Uno','Folio Uno',8,1),(9,'Folio Dos','Folio Dos',1,2);
...
CREATE TABLE `modulo` (
  ...
  KEY `fk_Modulo_Cara1_idx` (`Cara_id_cara`),
  KEY `fk_Modulo_Estante1_idx` (`Estante_id_estante`),
  CONSTRAINT `fk_Modulo_Cara1` FOREIGN KEY (`Cara_id_cara`) REFERENCES `cara` (`id_cara`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Modulo_Estante1` FOREIGN KEY (`Estante_id_estante`) REFERENCES `estante` (`id_estante`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `modulo` VALUES (1,'Modulo Uno',1,1),(2,'Modulo Uno',1,2),(3,'Modulo Uno',2,3),(4,'Modulo Uno',2,4),(5,'Modulo Uno',3,5),(6,'Modulo Uno',3,6),(7,'Modulo Uno',4,7),(8,'Modulo Uno',4,8),(9,'Modulo Uno',5,9),(10,'Modulo Uno',5,10),(11,'Modulo Uno',6,11),(12,'Modulo Uno',6,12),(13,'Modulo Uno',7,13),(14,'Modulo Uno',7,14),(15,'Modulo Uno',8,15),(16,'Modulo Uno',8,16),(17,'Modulo Uno',9,17),(18,'Modulo Uno',9,18),(19,'Modulo Uno',10,19),(20,'Modulo Uno',10,20),(21,'Modulo Dos',1,1),(22,'Modulo Dos',1,2),(23,'Modulo Dos',2,3),(24,'Modulo Dos',2,4),(25,'Modulo Dos',3,5),(26,'Modulo Dos',3,6),(27,'Modulo Dos',4,7),(28,'Modulo Dos',4,8),(29,'Modulo Dos',5,9),(30,'Modulo Dos',5,10),(31,'Modulo Dos',6,11),(32,'Modulo Dos',6,12),(33,'Modulo Dos',7,13),(34,'Modulo Dos',7,14),(35,'Modulo Dos',8,15),(36,'Modulo Dos',8,16),(37,'Modulo Dos',9,17),(38,'Modulo Dos',9,18),(39,'Modulo Dos',10,19),(40,'Modulo Dos',10,20);
...
CREATE TABLE `municipios` (
  ...
  KEY `fk_Ciudad_Departamento_idx` (`Departamento_id_departamento`),
  CONSTRAINT `fk_Ciudad_Departamento` FOREIGN KEY (`Departamento_id_departamento`) REFERENCES `departamento` (`id_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `piso` (
  ...
  `Modulo_id_modulo` int(11) NOT NULL,
  PRIMARY KEY (`id_piso`),
  KEY `fk_Piso_Modulo1_idx` (`Modulo_id_modulo`),
  KEY `fk_Piso_Estante1_idx` (`Estante_id_estante`),
  KEY `fk_Piso_Cara1_idx` (`Cara_id_cara`),
  CONSTRAINT `fk_Piso_Cara1` FOREIGN KEY (`Cara_id_cara`) REFERENCES `cara` (`id_cara`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Piso_Estante1` FOREIGN KEY (`Estante_id_estante`) REFERENCES `estante` (`id_estante`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Piso_Modulo1` FOREIGN KEY (`Modulo_id_modulo`) REFERENCES `modulo` (`id_modulo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `piso` VALUES (1,'Piso Uno',1,1,1),(2,'Piso Uno',1,2,2),(3,'Piso Uno',2,3,3),(4,'Piso Uno',2,4,4),(5,'Piso Uno',3,5,5),(6,'Piso Uno',3,6,6),(7,'Piso Uno',4,7,7),(8,'Piso Uno',4,8,8),(9,'Piso Uno',5,9,9),(10,'Piso Uno',5,10,10),(11,'Piso Uno',6,11,11),(12,'Piso Uno',6,12,12),(13,'Piso Uno',7,13,13),(14,'Piso Uno',7,14,14),(15,'Piso Uno',8,15,15),(16,'Piso Uno',8,16,16),(17,'Piso Uno',9,17,17),(18,'Piso Uno',9,18,18),(19,'Piso Uno',10,19,19),(20,'Piso Uno',10,20,20),(21,'Piso Uno',1,1,21),(22,'Piso Uno',1,2,22),(23,'Piso Uno',2,3,23),(24,'Piso Uno',2,4,24),(25,'Piso Uno',3,5,25),(26,'Piso Uno',3,6,26),(27,'Piso Uno',4,7,27),(28,'Piso Uno',4,8,28),(29,'Piso Uno',5,9,29),(30,'Piso Uno',5,10,30),(31,'Piso Uno',6,11,31),(32,'Piso Uno',6,12,32),(33,'Piso Uno',7,13,33),(34,'Piso Uno',7,14,34),(35,'Piso Uno',8,15,35),(36,'Piso Uno',8,16,36),(37,'Piso Uno',9,17,37),(38,'Piso Uno',9,18,38),(39,'Piso Uno',10,19,39),(40,'Piso Uno',10,20,40),(41,'Piso Dos',1,1,1),(42,'Piso Dos',1,2,2),(43,'Piso Dos',2,3,3),(44,'Piso Dos',2,4,4),(45,'Piso Dos',3,5,5),(46,'Piso Dos',3,6,6),(47,'Piso Dos',4,7,7),(48,'Piso Dos',4,8,8),(49,'Piso Dos',5,9,9),(50,'Piso Dos',5,10,10),(51,'Piso Dos',6,11,11),(52,'Piso Uno',6,12,12),(53,'Piso Dos',7,13,13),(54,'Piso Dos',7,14,14),(55,'Piso Dos',8,15,15),(56,'Piso Dos',8,16,16),(57,'Piso Dos',9,17,17),(58,'Piso Dos',9,18,18),(59,'Piso Dos',10,19,19),(60,'Piso Dos',10,20,20),(61,'Piso Dos',1,1,21),(62,'Piso Dos',1,2,22),(63,'Piso Dos',2,3,23),(64,'Piso Dos',2,4,24),(65,'Piso Dos',3,5,25),(66,'Piso Dos',3,6,26),(67,'Piso Dos',4,7,27),(68,'Piso Dos',4,8,28),(69,'Piso Dos',5,9,29),(70,'Piso Dos',5,10,30),(71,'Piso Dos',6,11,31),(72,'Piso Dos',6,12,32),(73,'Piso Dos',7,13,33),(74,'Piso Dos',7,14,34),(75,'Piso Dos',8,15,35),(76,'Piso Dos',8,16,36),(77,'Piso Dos',9,17,37),(78,'Piso Dos',9,18,38),(79,'Piso Dos',10,19,39),(80,'Piso Dos',10,20,40);
...
CREATE TABLE `prestamo` (
  ...
  KEY `fk_Prestamo_Usuarios1_idx` (`Usuarios_id_usuario`),
  KEY `fk_Prestamo_Tipo_de_prestamo1_idx` (`Tipo_de_prestamo_id_tipo_prestamo`),
  KEY `fk_Prestamo_Prioridad_prestamo1_idx` (`Prioridad_prestamo_id_prioridad`),
  CONSTRAINT `fk_Prestamo_Prioridad_prestamo1` FOREIGN KEY (`Prioridad_prestamo_id_prioridad`) REFERENCES `prioridad_prestamo` (`id_prioridad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Prestamo_Tipo_de_prestamo1` FOREIGN KEY (`Tipo_de_prestamo_id_tipo_prestamo`) REFERENCES `tipo_de_prestamo` (`id_tipo_prestamo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Prestamo_Usuarios1` FOREIGN KEY (`Usuarios_id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `prioridad_prestamo`
--

DROP TABLE IF EXISTS `prioridad_prestamo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `prioridad_prestamo`
--

LOCK TABLES `prioridad_prestamo` WRITE;
/*!40000 ALTER TABLE `prioridad_prestamo` DISABLE KEYS */;
INSERT INTO `prioridad_prestamo` VALUES (1,'Normal'),(2,'Urgente');
/*!40000 ALTER TABLE `prioridad_prestamo` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tipo_caja`
--

LOCK TABLES `tipo_caja` WRITE;
/*!40000 ALTER TABLE `tipo_caja` DISABLE KEYS */;
INSERT INTO `tipo_caja` VALUES (1,'2 x 2'),(2,'3 x 3');
/*!40000 ALTER TABLE `tipo_caja` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tipo_de_prestamo`
--

DROP TABLE IF EXISTS `tipo_de_prestamo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
...
--
-- Dumping data for table `tipo_de_prestamo`
--

LOCK TABLES `tipo_de_prestamo` WRITE;
/*!40000 ALTER TABLE `tipo_de_prestamo` DISABLE KEYS */;
INSERT INTO `tipo_de_prestamo` VALUES (1,'Interno'),(2,'Externo');
/*!40000 ALTER TABLE `tipo_de_prestamo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tipos_de_usuario` VALUES (1,'Administrador'),(2,'Archivador'),(3,'Cliente');
/*!40000 ALTER TABLE `tipos_de_usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `ubicacion_caja`
--

DROP TABLE IF EXISTS `ubicacion_caja`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `ubicacion_caja` (
  `id_ubicacion_caja` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_Ubicacion_caja_Entrepano1_idx` (`Entrepano_id_entrepano`),
  CONSTRAINT `fk_Ubicacion_caja_Entrepano1` FOREIGN KEY (`Entrepano_id_entrepano`) REFERENCES `entrepano` (`id_entrepano`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=321 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ubicacion_caja`
--

LOCK TABLES `ubicacion_caja` WRITE;
/*!40000 ALTER TABLE `ubicacion_caja` DISABLE KEYS */;
INSERT INTO `ubicacion_caja` VALUES (1,'A','B','C',1,1),(2,'A','B','C',1,2),(3,'A','B','C',1,3),(4,'A','B','C',1,4),(5,'A','B','C',1,5),(6,'A','B','C',1,6),(7,'A','B','C',1,7),(8,'A','B','C',1,8),(9,'A','B','C',1,9),(10,'A','B','C',1,10),(11,'A','B','C',1,11),(12,'A','B','C',1,12),(13,'A','B','C',1,13),(14,'A','B','C',1,14),(15,'A','B','C',1,15),(16,'A','B','C',1,16),(17,'A','B','C',1,17),(18,'A','B','C',1,18),(19,'A','B','C',1,19),(20,'A','B','C',1,20),(21,'A','B','C',1,21),(22,'A','B','C',1,22),(23,'A','B','C',1,23),(24,'A','B','C',1,24),(25,'A','B','C',1,25),(26,'A','B','C',1,26),(27,'A','B','C',1,27),(28,'A','B','C',1,28),(29,'A','B','C',1,29),(30,'A','B','C',1,30),(31,'A','