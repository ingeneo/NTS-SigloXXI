...
INSERT INTO `bodega` VALUES (1,'Norte','Cra 243','5555555',107),(2,'Sur','Call 4 sur 27','2333333',91),(3,'Prueba','Prueba1','2333551',756);
...
INSERT INTO `cajas` VALUES (1,'S1','Papeles de prueba',1),(2,'8','7yhygt',2);
...
INSERT INTO `carpeta` VALUES (1,'CP 1',1);
...
CREATE TABLE `clientes` (
  ...
  KEY `fk_clientes_Municipios1_idx` (`Municipios_id_municipio`),
  CONSTRAINT `fk_clientes_Municipios1` FOREIGN KEY (`Municipios_id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `clientes` VALUES (1,'830027960-7','SigloXXI','Cra falsa','7999999','siglo@nts.com',107),(2,'810028050-7','Prueba','Poblado','8521414','sede@nts',547);
...
INSERT INTO `estado_caja` VALUES (1,'Custodia'),(2,'Prestado');
...
INSERT INTO `estante` VALUES (1,'2','3','4','5',1);
...
CREATE TABLE `ubicacion_caja` (
  ...
  `Estado_caja_id_estado_caja` int(11) NOT NULL,
  `Estante_id_estante` int(11) NOT NULL,
  PRIMARY KEY (`id_ubicacion_caja`),
  KEY `fk_Ubicacion_caja_Estado_caja1_idx` (`Estado_caja_id_estado_caja`),
  KEY `fk_Ubicacion_caja_Estante1_idx` (`Estante_id_estante`),
  CONSTRAINT `fk_Ubicacion_caja_Estado_caja1` FOREIGN KEY (`Estado_caja_id_estado_caja`) REFERENCES `estado_caja` (`id_estado_caja`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Ubicacion_caja_Estante1` FOREIGN KEY (`Estante_id_estante`) REFERENCES `estante` (`id_estante`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ubicacion_caja` VALUES (1,'A','B','C',2,1,1),(2,'1','2','5',2,1,1);
...
INSERT INTO `usuarios` VALUES (1,'Roger A','Valencia G',70258963,'3124567893','roger@hotmail.com','\"#%$/&/(!',1,1),(2,'Rafael A','Lancheros R',79654321,'3216549874','franco@gmail.com','/(&&%&%UHJ',2,2);
...
-- Dump completed on 2019-09-25 16:42:59
