...
CREATE TABLE IF NOT EXISTS `NTS`.`Municipios` (
  ...
  INDEX `fk_Ciudad_Departamento_idx` (`Departamento_id_departamento` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Clientes` (
  ...
  INDEX `fk_Gestores_Municipios1_idx` (`Municipios_id_municipio` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Usuarios` (
  ...
  INDEX `fk_Usuarios_Tipos_de_usuario1_idx` (`Tipos_de_usuario_id_Tipo_usuario` ASC),
  INDEX `fk_Usuarios_Clientes1_idx` (`Clientes_id_cliente` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Bodega` (
  ...
  INDEX `fk_Bodega_Municipios1_idx` (`Municipios_id_municipio` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Estante` (
  ...
  INDEX `fk_Estante_Bodega1_idx` (`Bodega_id_bodega` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Cara` (
  ...
  PRIMARY KEY (`id_cara`),
  INDEX `fk_Cara_Estante1_idx` (`Estante_id_estante` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Modulo` (
  ...
  INDEX `fk_Modulo_Cara1_idx` (`Cara_id_cara` ASC),
  INDEX `fk_Modulo_Estante1_idx` (`Estante_id_estante` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Piso` (
  ...
  PRIMARY KEY (`id_piso`),
  INDEX `fk_Piso_Modulo1_idx` (`Modulo_id_modulo` ASC) ,
  INDEX `fk_Piso_Estante1_idx` (`Estante_id_estante` ASC),
  INDEX `fk_Piso_Cara1_idx` (`Cara_id_cara` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Entrepano` (
  ...
  INDEX `fk_Entrepano_Piso1_idx` (`Piso_id_piso` ASC),
  INDEX `fk_Entrepano_Modulo1_idx` (`Modulo_id_modulo` ASC),
  INDEX `fk_Entrepano_Cara1_idx` (`Cara_id_cara` ASC),
  INDEX `fk_Entrepano_Estante1_idx` (`Estante_id_estante` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Ubicacion_caja` (
  ...
  INDEX `fk_Ubicacion_caja_Entrepano1_idx` (`Entrepano_id_entrepano` ASC),
...
INSERT INTO `Ubicacion_caja` VALUES (1,'A','B','C',2,1),(2,'1','2','5',2,1);
...
CREATE TABLE IF NOT EXISTS `NTS`.`Cajas` (
  ...
  PRIMARY KEY (`id_caja`),
  INDEX `fk_Cajas_Ubicacion_caja1_idx` (`Ubicacion_caja_id_ubicacion_caja` ASC),
  INDEX `fk_Cajas_Estado_item1_idx` (`Estado_item_id_estado_item` ASC),
  INDEX `fk_Cajas_Tipo_caja1_idx` (`Tipo_caja_id_tipo_caja` ASC),
...
INSERT INTO `Cajas` VALUES (1,'S1','Papeles de prueba',1,1,1),(2,'8','7yhygt',2,1,2);
...
CREATE TABLE IF NOT EXISTS `NTS`.`Prestamo` (
  ...
  INDEX `fk_Prestamo_Usuarios1_idx` (`Usuarios_id_usuario` ASC),
  INDEX `fk_Prestamo_Tipo_de_prestamo1_idx` (`Tipo_de_prestamo_id_tipo_prestamo` ASC),
  INDEX `fk_Prestamo_Prioridad_prestamo1_idx` (`Prioridad_prestamo_id_prioridad` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Cajas_has_Prestamo` (
  ...
  INDEX `fk_Cajas_has_Prestamo_Prestamo1_idx` (`Prestamo_id_prestamo` ASC),
  INDEX `fk_Cajas_has_Prestamo_Cajas1_idx` (`Cajas_id_caja` ASC),
...
CREATE TABLE IF NOT EXISTS `NTS`.`Carpeta` (
  ...
  INDEX `fk_Carpeta_Cajas1_idx` (`Cajas_id_caja` ASC),
  INDEX `fk_Carpeta_Estado_item1_idx` (`Estado_item_id_estado_item` ASC),
...
INSERT INTO `Carpeta` VALUES (1,'CP 1',1,1);
...
CREATE TABLE IF NOT EXISTS `NTS`.`Folio` (
  ...
  INDEX `fk_Folio_Carpeta1_idx` (`Carpeta_id_carpeta` ASC),
  INDEX `fk_Folio_Estado_item1_idx` (`Estado_item_id_estado_item` ASC),
